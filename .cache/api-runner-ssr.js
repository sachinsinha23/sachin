var plugins = [{
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-mdx/gatsby-ssr'),
      ...
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-theme-ui/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-google-analytics/gatsby-ssr'),
      options: {"plugins":[],"head":false,"anonymize":false,"respectDNT":false,"exclude":[],"pageTransitionDelay":0},
    },{
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
      ...
      plugin: require('/home/suraj/workspace/git/sachin/node_modules/gatsby-plugin-offline/gatsby-ssr'),
      options: {"plugins":[]},
    }]
